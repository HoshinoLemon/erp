import { AnyMap, originalPositionFor, generatedPositionFor, eachMapping } from '../../trace-mapping/types/trace-mapping.d.mts';
import { GenMapping, maybeAddMapping, toDecodedMap, toEncodedMap, setSourceContent } from '../../gen-mapping/types/gen-mapping.d.mts';
import type { TraceMap, SourceMapInput, SectionedSourceMapInput, DecodedSourceMap } from '../../trace-mapping/types/trace-mapping.d.mts';
export type { TraceMap, SourceMapInput, SectionedSourceMapInput, DecodedSourceMap };
import type { Mapping, EncodedSourceMap } from '../../gen-mapping/types/gen-mapping.d.mts';
